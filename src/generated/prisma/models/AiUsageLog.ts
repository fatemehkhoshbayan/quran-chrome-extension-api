...
export type AiUsageLogWhereInput = {
  ...
  sub?: Prisma.StringFilter<"AiUsageLog"> | string
...
export type AiUsageLogScalarWhereWithAggregatesInput = {
  ...
  sub?: Prisma.StringWithAggregatesFilter<"AiUsageLog"> | string
...
export type AiUsageLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "sub" | "createdAt", ExtArgs["result"]["aiUsageLog"]>
...
export interface AiUsageLogFieldRefs {
  ...
  readonly sub: Prisma.FieldRef<"AiUsageLog", 'String'>
